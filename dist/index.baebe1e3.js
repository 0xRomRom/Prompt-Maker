...
const addtoDiv = (img, i)=>{
    ...
    newPar.textContent = Object.values((0, _catIndexJs.animals))[i];
...
allSubs.forEach((item)=>{
    item.addEventListener("click", (e)=>{
        ...
        for(let i = 0; i < iLen; i++)(0, _storage.getDownloadURL)((0, _storage.ref)(storage, `/${(0, _animateJs.targetCategory)}/${item.dataset.id}/${i}.png`)).then((url)=>{
            addtoDiv(url, i);
        }).catch((err)=>{
            console.log(err);
        });
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","tslib":"lRdW5","@firebase/logger":"fZmft","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9dDUH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _storage = require("@firebase/storage");
