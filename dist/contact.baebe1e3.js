...
// const storageRef = ref(storage, "//subject/animals");
// console.log(storageRef);
// firebase emulators:start --only auth
const storage = (0, _storage.getStorage)();
(0, _storage.getDownloadURL)((0, _storage.ref)(storage, `subject/animals/Alpaca.png`)).then((url)=>{
    console.log(url);
}).catch((error)=>{
    console.log(error);
});
const buttonz = document.querySelector(".some-button");
buttonz.addEventListener("click", (e)=>{
    console.log(e.target.dataset.id);
    const img = document.getElementById("myimg");
    img.src = "";
}); // const storage = getStorage();
 // getDownloadURL(ref(storage, "subject/animals/Cheetah.png"))
 //   .then((url) => {
...
},{"firebase/app":"5wGMN","firebase/storage":"9dDUH","firebase/auth":"drt1f"}],"5wGMN":[function(require,module,exports) {
...
//# sourceMappingURL=contact.baebe1e3.js.map
