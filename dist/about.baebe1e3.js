...
})({"5VBqy":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ba0204dbbaebe1e3";
...
parcelHelpers.export(exports, "passwordRegister", ()=>passwordRegister);
...
},{"firebase/auth":"drt1f","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","firebase/app":"5wGMN","./script.js":"jUTag"}],"drt1f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _auth = require("@firebase/auth");
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","tslib":"lRdW5","@firebase/logger":"fZmft","@firebase/component":"bi1VB","./index-90ebcfae.js":"3zWZm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ePiK6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jUTag":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "loginNav", ()=>loginNav);
parcelHelpers.export(exports, "hideLogin", ()=>hideLogin);
parcelHelpers.export(exports, "signupBack", ()=>signupBack);
...
subjectPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        subjectCount++;
        totalCount++;
        (0, _animateJs.subjectCounter).textContent = subjectCount;
        subjectMiniCounter.textContent = subjectCount;
        (0, _animateJs.totalCounter).textContent = totalCount;
        promptString.focus();
    });
});
...
locationPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        locationCount++;
        totalCount++;
        (0, _animateJs.locationCounter).textContent = locationCount;
...
themesPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        themesCount++;
        totalCount++;
        (0, _animateJs.themesCounter).textContent = themesCount;
...
designPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        designCount++;
        totalCount++;
        (0, _animateJs.designCounter).textContent = designCount;
...
lightningPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        lightningCount++;
        totalCount++;
        (0, _animateJs.lightningCounter).textContent = lightningCount;
...
colorsPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        colorsCount++;
        totalCount++;
        (0, _animateJs.colorsCounter).textContent = colorsCount;
...
cameraPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        cameraCount++;
        totalCount++;
        (0, _animateJs.cameraCounter).textContent = cameraCount;
...
artistsPick.forEach((item)=>{
    item.addEventListener("click", ()=>{
        ...
        artistsCount++;
        totalCount++;
        (0, _animateJs.artistsCounter).textContent = artistsCount;
...
},{"./firebase.js":"1SoyA","./animate.js":"eMc9v","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eMc9v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./script.js":"jUTag","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5VBqy","1SoyA"], "1SoyA", "parcelRequire1ccf")
